...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        client.getWallet().addHolding("ICN", 50);
        client.getWallet().addHolding("BTC", 20);
        client.getWallet().addHolding("ETH", 0.5);
        client.getWallet().addHolding("ZRX", 0.5);
        client.getWallet().addHolding("FUN", 0.5);
        client.getWallet().addHolding("SUB", 0.5);
        client.getWallet().addHolding("EOS", 0.5);
